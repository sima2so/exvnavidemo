 ...
 * Use the [ShowRoutePlanFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NaviWithEnergyGraphFragment : Fragment() {
...
//            t0.text=cnt.toString()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_navi_with_energygraph, container, false)
    }
